...
const erasData = [
  {
    ...
    tagline: "Le règne du copier-coller, la mise en page par <table> et les scripts 800x600",
    ...
    whyImportant: "À l'origine, pour créer une nouvelle page, on duplique simplement la précédente. C'est l'époque fétiche de l'importance absolue de la balise \"table\". Détournée par des millions de codeurs, elle permettait de structurer et de concevoir un site entier \"sur mesure\" en rigidifiant l'affichage dans un quadrillage précis. On programmait également de menus scripts Javascript de redirection pour détecter si l'internaute surfait sur un écran en résolution 800x600 ou 1024x768 afin d'ajuster le design.",
    ...
    tree: [
      ...
      { name: "layout_table_sur_mesure.html", type: "file", desc: "La structure de mise en page reposant entièrement sur la balise <table>.", detail: "La balise <table> a été utilisée par des millions de codeurs d'époque pour découper l'écran et concevoir un site 'sur mesure'. En imbriquant des lignes (<tr>) et des cellules (<td>) sans CSS, on parvenait à aligner de force menus, logos et bannières." },
      { name: "detect_resolution.js", type: "file", desc: "Un script d'analyse de la résolution d'écran (800 vs 1024 pixels).", detail: "Ce code Javascript analysait screen.width pour rediriger l'utilisateur. Si l'écran était en 800 (800x600), il chargeait une version étroite du site; s'il était en 1024 (1024x768), il chargeait la version standard pour éviter de casser la grille en tableur." },
